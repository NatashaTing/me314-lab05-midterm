...
<ul style="background-color:#e6ffe6; padding: 3%">
  ...
  <li>For non-urban, an additional thousand dollar increase in advertising budget is associated with 0.128015, which is a 0.13 rise in unit sales.</li>
</ul>
...
<ul style="background-color:#e6ffe6; padding: 3%">
  ...
  <li>The **second model is less preferred** because: </li>  
    ...
    $$H_0: \widehat{\beta}_\text{Urban} == \widehat{\beta}_\text{Urban*Advertising} == 0$$</li></ul>
      <li>there is **no noticable increase in model explanatory power** from including interaction term, with $R^2$ constant at `0.2819`when rounded</li>; and
...
<ul style="background-color:#e6ffe6; padding: 3%">
  ...
  <li>**`Direction`**
    <ul>
      <li>Direction seems to be evaluated relative tothe percentage for this week. Therefore, `Direction` will cause a **perfect separation** in regression. </li>
...
<ol style="background-color:#e6ffe6; padding: 3%">
  ...
  <li>**Sensitivity** (a.k.a. **Recall**, True Positive Rate ) = `0.8713`
    <ul>
      ...
      <li> **The model correctly predicted 87% of the number of total bullish days.** </li>
    </ul>
  </li>
  ...
  <li>**Specificity** (a.k.a. true negative rate) = `0.1814`
    <ul>
      ...
      <li>**The model correctly predicted 87% of the number of total bearish days.** </li>
    </ul>
  </li>
